...
# the child immediately imports ``rlmstudio.tools.content`` (and, in safe
# mode, ``rlmstudio.envs.sandbox``) at the top of ``_child_worker``.  Module
...
#
#     from rlmstudio.infrastructure.sandbox.subprocess_sandbox import ...
#
#     def main():
...
def _child_worker(
    ...
    if safe_mode:
        from rlmstudio.envs.sandbox import create_safe_globals
    ...
    try:
        ...
        from rlmstudio.application.sandbox_vars import SANDBOX_VAR_DOCUMENT
    ...
    from rlmstudio.application.sandbox_vars import SANDBOX_SKIP_RETURN_VARS
