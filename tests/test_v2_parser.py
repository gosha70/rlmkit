...
responses = ['{"type": "final", "answer": "The answer is 42", "confidence": 0.95}']

client = MockLLMClient(responses)
rlm = RLM(client=client, config=config)

result = rlm.run(prompt="No content needed", query="What is the meaning of life?")
...
result = rlm.run(prompt="Test", query="Test markdown")
