...
from rlmkit import interact, complete, InteractResult
...
MEDIUM_TEXT = "x" * 10000  # 10K characters (~2.5K tokens)
...
class TestInteractBasics:
    ...
    def test_interact_returns_interact_result(self):
        ...
        client = MockLLMClient(["Final answer: This is about Python."])
    ...
    def test_interact_result_has_required_fields(self):
        ...
        client = MockLLMClient(["Final answer: Test response."])
    ...
    def test_interact_result_str(self):
        ...
        client = MockLLMClient(["Final answer: String test."])
    ...
    def test_interact_result_to_dict(self):
        ...
        client = MockLLMClient(["Final answer: Dict test."])
...
class TestRawResultAccess:
    ...
    def test_raw_result_matches_interact_result(self):
        ...
        assert result.metrics['total_tokens'] == result.raw_result.total_tokens
