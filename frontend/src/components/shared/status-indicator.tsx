...
type Status = "connected" | "offline" | "warning" | "loading" | "not_configured" | "configured";
...
export function StatusIndicator({ status, label, className }: StatusIndicatorProps) {
  ...
  return (
    ...
    >
      <span className={cn("inline-block h-2 w-2 rounded-full", dotColor, isLoading && "animate-pulse")} aria-hidden="true" />
      <Icon className={cn("h-3.5 w-3.5", color, isLoading && "animate-spin")} aria-hidden="true" />
